...
server.setRequestHandler(ListToolsRequestSchema, async () => {
  return {
    tools: [
      ...
      {
        name: "code_roaster",
        description: "Provide humorous (but constructive) code review comments",
        inputSchema: {
          type: "object",
          properties: {
            filePath: {
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            prdContent: {
              type: "string",
              description: "The complete PRD content in Markdown format",
            },
            projectName: {
              type: "string",
              description: "Name of the project (used for filename)",
            },
            projectRoot: {
              type: "string",
              description: "Root directory of the project (optional)",
    ...
    case "write_codified_patterns":
      try {
        ...
        if (existsSync(instructionsPath)) {
          existingInstructions = readFileSync(instructionsPath, "utf-8");
        }
...
`;
    ...
    case "code_roaster":
      try {
        ...
        const roastPrompt = roastPrompts[roastStyle] || roastPrompts["gentle"];
...
Please provide your roast as a bulleted list of humorous but constructive code review comments.`,
    ...
    case "find_todos":
      try {
        ...
        const filePattern =
          args.filePattern || "**/*.{js,ts,jsx,tsx,md,py,java,c,cpp,h}";
